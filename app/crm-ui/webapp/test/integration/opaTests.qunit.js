...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "crm/crmui/test/integration/CustomersListJourney.gen",
    "crm/crmui/test/integration/CustomersObjectPageJourney.gen",
    "crm/crmui/test/integration/InteractionsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
